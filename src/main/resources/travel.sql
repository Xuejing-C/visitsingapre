...
insert into tab_viewpoint (vname, location, introduce, detail, cid, smallImg) values
                                                                                  ...
                                                                                  ('Adventure Cove Waterpark','8 Sentosa Gateway, Sentosa Island, Singapore 098269','Make a big splash at this aquatic adventure park at Resorts World™ Sentosa.',
                                                                                   ...
                                                                                   1,'img/adventure_cove_waterpark_1.jpg'),
...
alter table tab_favorite add constraint FK_viewpoint_favorite foreign key (vid)
    references tab_viewpoint (vid) on delete restrict on update restrict;
